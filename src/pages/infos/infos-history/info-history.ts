...
export class InfosHistoryPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private dataservice: DataService,  private app: App) {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad InfosHistoryPage');
  }
